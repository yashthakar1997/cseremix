...
<body class="home blog">
	...
	<ul class="sf-menu"><li class="menu-item current-menu-item"><a href="index.php">Home</a></li>
	<li class="menu-item"><a href="offers.php">Offers</a></li>
    <li class="menu-item"><a href="about.php">About us</a></li>
    <li class="menu-item"><b id="logout"><a href="logout.php">Log Out</a></b></li>
</ul>	
                    <!-- End Navigation Menu -->
    ...
    <div class="container zerogrid">
        ...
        <div class="col-12" id="post-container" >
            ...
            <div class="post" >
                ...
                <center> <h4 class="post-title"><a href="#">welcome <?php echo $login_session; ?></a></h4></center>
            ...
            <div class="post" >
                ...
                <center> <h4 class="post-title"><a href="#"> Map locations </a></h4></center>
                 ...
                 <div>
                    ...
                    <div id="map-canvas" class="attachment-post-standard "></div>
                    <?php include ('DB/db_show.php');?>
            ...
            <script>
                var off = <?php echo json_encode($offr);?>;
                
            </script>
            <div><script src="map.js"></script>  </div>                                    
          ...
          <div class="container zerogrid">
            ...
            <div class="post">
                ...
                <center> <h4 class="post-title"><a href="#">Search Other locations</a></h4></center>
                    <div class="clear"></div>
                </div>
                 <div>
                    ...
                    <center><input id="address" name="Search" type="text" value="gujarat,india">
                    <input type="submit" value="Find It" onclick="codeAddress()"></center>
                 </div>
             </div>
             </div>
            </div>        
